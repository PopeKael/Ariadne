...
| D: | Durable data, models, repositories, Knowledge Vault, backups |
| E: | Video editing and media processing |
| F: | One Ubuntu WSL environment, active Linux tooling, builds, databases, scratch |

## Guardrails

- Ubuntu WSL capacity ceiling: 128 GB.
- Model repositories must use explicit D: paths.
